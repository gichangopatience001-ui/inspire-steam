...
#Date : 11/02/2026
# Program to add, subtract, divide, multiply
...
#quocient_numbers = first_number / second_number
...
#print(f"The quocient of the numbers {quocient_numbers}")
...
#Convert third_number to an integer

third_number = int(third_number)
print(f"Third number is :{type(third_number)}")